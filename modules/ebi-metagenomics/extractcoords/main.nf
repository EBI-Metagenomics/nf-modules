...
process EXTRACTCOORDS {
    ...
    tuple val(meta),  path("*concat_SSU_LSU_coords")             , emit: concat_ssu_lsu_coords
    ...
    cat SSU_coords LSU_coords > ${prefix}_concat_SSU_LSU_coords
    ...
    """
    touch ${prefix}_concat_SSU_LSU_coords
