...
(() => {
    var t = {
            ...
            415: (t, e) => {
                "use strict";
                Object.defineProperty(e, "__esModule", { value: !0 }), (e.downloadSvg = e.initDownloadButtons = void 0);
                ...
                function d(t, e, n, i, a, o, s, l) {
                    ...
                    f
                        ...
                        f
                            ...
                            .attr("class", "jsdomain-text");
                    const p = (0, r.path)();
                    p.moveTo(50, 50), p.arc(0, 50, 50, 0, (Math.PI / 180) * 45, !0), p.moveTo(50, 50), p.lineTo(10, 40);
                    const m = p.toString();
                    g.append("path")
                        .attr("d", m)
                        ...
                        (F = n / 10),
                            ...
                            (function (t, e, n, r, i, a, o, l, c, u) {
                                ...
                                const y = t
                                    ...
                                    .on("click", (t) => {
                                        ($(`.${g}`).length !== e.length && (s.event.ctrlKey || s.event.metaKey)) || L(),
                    ...
                    switch ((r = it(null == r ? ",f" : r)).type) {
                        ...
                        case "r":
                            null != r.precision ||
                                isNaN(
                                    (i = (function (t, e) {
                                        return (t = Math.abs(t)), (e = Math.abs(e) - t), Math.max(0, et(e) - et(t)) + 1;
                                ...
                                if (
                                    ...
                                    for (i = -1, s = t.length; ++i < s; )
                                        if (48 > (c = t.charCodeAt(i)) || c > 57) {
                                            (w = (46 === c ? a + t.slice(i + 1) : t.slice(i)) + w), (t = t.slice(0, i));
                                            break;
                                        }
                            }
                            d && !u && (t = r(t, 1 / 0));
                ...
                function L(t, e, n, r, i, a) {
                    ...
                    !(function (t, e, n) {
                        ...
                        (i[e] = n),
                            (n.timer = b(
                                function (t) {
                                    (n.state = M), n.timer.restart(a, n.delay, n.time), n.delay <= t && a(t - n.delay);
                                },
                                0,
                                n.time,
                            ));
                    ...
                    (t.exports = class {
                        ...
                        scale(t) {
                            ...
                            for (var a = 0; a < t.length; a++) {
                                ...
                                let o = t[a].position;
                                e < o.x && (e = o.x), n < o.y && (n = o.y), r > o.x && (r = o.x), i > o.y && (i = o.y);
                            }
                    ...
                    getMolecularFormula() {
                        ...
                        for (var n = 0; n < this.graph.vertices.length; n++) {
                            ...
                            if (
                                ...
                                t.isPartOfAromaticRing && n--, e.has("H") ? e.set("H", e.get("H") + n) : e.set("H", n);
                            }
                        }
                        if (e.has("C")) {
                            let n = e.get("C");
                ...
                class s {
                    ...
                    kkLayout(t, e, n, i, a) {
                        ...
                        for (s = u; s--; ) {
                            let e = t[s],
                                n = this.vertices[e];
                            (n.position.x = f[s]), (n.position.y = p[s]), (n.positioned = !0), (n.forcePositioned = !0);
                        }
                    }
